...
class LocalMlpBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.n_div = n_div
        self.attention = CoordAtt(dim,dim)
...
class FLENet(nn.Module):
    ...
    def __init__(self,
        ...
        if self.ResLT_drop:
           self.ResLT_dropout = nn.Dropout(p=0.2)
        ...
        self.finalBlock = nn.Sequential(
                       nn.Conv2d(self.num_features, self.num_features * 3, 1, bias=False),
        ...
        self.avgpool_pre_head = nn.Sequential(
            ...
            nn.Conv2d(self.num_features * 3, feature_dim * 3, 1, bias=False),
            act_layer()
        )
...
# def count(model):
#     model_torchstat(model,(3,128,128))
