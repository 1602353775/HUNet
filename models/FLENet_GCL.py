...
class FLENet_GCL(nn.Module):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(FLENet_GCL,self).__init__()
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(1)
        # self.head = nn.Linear(feature_dim,num_classes)
        self.classifier = Classifier(feature_dim,num_classes,'Norm')
...
def FLENet_GCL_XT(num_classes):
    model = FLENet_GCL(in_chans=3,
                 img_size=128,
